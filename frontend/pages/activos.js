      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6 bg-gray-100 min-h-screen">
          ...
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md mb-8">
            ...
            <button type="submit" className="mt-6 bg-blue-600 text-white px-6 py-3 rounded-lg">{editando ? "Actualizar" : "Guardar"}</button>
          </form>
          <div className="bg-white p-6 rounded-xl shadow-md overflow-x-auto">
            <table className="w-full border">
              <thead className="bg-gray-200">
                <tr><th className="p-3">Nombre</th><th className="p-3">Serial</th><th className="p-3">Acciones</th></tr>
              </thead>
              <tbody>
                {activos?.map((a) => (
                  <tr key={a.id} className="border-b">
                    ...
                    <td className="p-3"><button onClick={() => editarActivo(a)} className="bg-yellow-500 text-white px-3 py-1 rounded">Editar</button></td>
                  </tr>
                ))}
              </tbody>
            </table>
